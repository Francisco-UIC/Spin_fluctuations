% This script computes the bare susceptibility in real frequencies from the
% spectral function (obtained in BZ_quadrant.m)
...
% The energy-momentum sum of the spectral function must equal N, the number 
% of momentum points:
...
om = linspace(0,0.2,80);     % 160 energies ("OMega") over which chi0 will be sampled (eV)
