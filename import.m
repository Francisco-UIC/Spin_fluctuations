...
%User should have a folder with 16-18 files (depending on data set in
...
%another scritp. Of course, this script also extracts the actual
%ARPES data and stores them in the form of a cell array with 16-18 cells.
%This output array is called "data"

%Retrieve file names using 'dir' function
...
for i=1:numfiles
    ...
    %Therefore, we avarage the spectra over a few energies close to this reference
    %energy.
